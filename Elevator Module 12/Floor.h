...
class Floor
{
  ...
  bool hasUpRider() const {return !upRiders.empty();}//add for Assignment 7
  bool hasDownRider() const {return !downRiders.empty();}
  Rider removeUpRider();//For Assignment 8
  Rider removeDownRider();
  unsigned int getNumberOfUpRiders() const {return upRiders.size();}// A 10
